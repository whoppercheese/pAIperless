...
from f.paiperless.shared.prompts import SUMMARY_SCHEMA, build_summary_prompt
from f.paiperless.shared.text_utils import language_name, normalize_language
...
def main(
    ...
    if not document_date:
        warnings.append("LLM hat kein Dokumentdatum geliefert")
