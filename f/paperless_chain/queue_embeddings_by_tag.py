...
from f.paperless_chain.shared.windmill_client import run_embed_document_async
...
def main(
    ...
    for document in documents:
        ...
        job_id = run_embed_document_async(doc_id)
        queued.append({
            "doc_id": doc_id,
            "title": document.get("title") or "",
            "job_id": job_id,
    ...
    print("=== Paperless-chAIn Queue Embeddings by Tag ===")
